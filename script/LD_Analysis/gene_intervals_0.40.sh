...
#PBS -l mem=22gb,nodes=1:ppn=16,walltime=05:00:00
#PBS -m abe
...
BED_LIST=/home/morrellp/liux1299/Shared/Projects/Land_Env_Assoc/Analysis/LD_Analysis/results/gwas_sig_snps_200Kb/0.40_threshold/extracted_window/bed_win_list.txt
#   BED file prefix and suffix
BED_PREFIX=ld_Barley_NAM_200Kb_0.40_
...
OUT_DIR=/home/morrellp/liux1299/Shared/Projects/Land_Env_Assoc/Analysis/LD_Analysis/results/gwas_sig_snps_200Kb/0.40_threshold/gene_intervals
